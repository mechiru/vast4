    ...
    Vast {
        ...
        ads: vec![Ad {
            ...
            in_line: Some(InLine {
                ...
                ad_serving_id: Cow::Borrowed("a532d16d-4d7f-4440-bd29-2ec0e693fc82"),
                categories: vec![
                    Category {
                        authority: Cow::Borrowed("https://www.iabtechlab.com/categoryauthority"),
                        code: Cow::Borrowed("American Cuisine")
                    },
                    Category {
                        authority: Cow::Borrowed("https://www.iabtechlab.com/categoryauthority"),
                        code: Cow::Borrowed("Guitar")
                    },
                    Category {
                        authority: Cow::Borrowed("https://www.iabtechlab.com/categoryauthority"),
                        code: Cow::Borrowed("Vegan")
                    },
                ],
                ...
                creatives: Creatives {
                    creatives: vec![Creative {
                        ...
                        universal_ad_id: vec![
                            ...
                            UniversalAdId {
                                id_registry: Cow::Borrowed("FOO-ID"),
                                id: Cow::Borrowed("6666465")
                            },
                        ],
                        linear: Some(Linear {
