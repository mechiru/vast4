    ...
    Vast {
        ...
        ads: vec![Ad {
            ...
            in_line: Some(InLine {
                ...
                ad_verifications: Some(AdVerifications {
                    verifications: vec![
                        Verification {
                            javascript_resources: vec![JavaScriptResource {
                                uri: Cow::Borrowed(
                        ...
                        Verification {
                            javascript_resources: vec![JavaScriptResource {
                                uri: Cow::Borrowed("https://verificationcompany.com/untrusted.js"),
                                ..Default::default()
                            }],
                            ..Default::default()
                        },
