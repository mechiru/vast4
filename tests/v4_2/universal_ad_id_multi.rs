    ...
    Vast {
        ...
        ads: vec![Ad {
            ...
            in_line: Some(InLine {
                ...
                ad_serving_id: Cow::Borrowed("a532d16d-4d7f-4440-bd29-2ec0e693fc81"),
                ...
                creatives: Creatives {
                    creatives: vec![Creative {
                        ...
                        universal_ad_id: vec![
                            ...
                            UniversalAdId {
                                id_registry: Cow::Borrowed("FooId"),
                                id: Cow::Borrowed("9999"),
                            },
                            UniversalAdId {
                                id_registry: Cow::Borrowed("BarId"),
                                id: Cow::Borrowed("ADSe9999"),
                            },
                        ],
                        linear: Some(Linear {
