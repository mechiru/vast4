                            ...
                            icons: Some(Icons {
                                icons: vec![Icon {
                                    static_resources: vec![StaticResource {
                                        ...
                                        uri: Cow::Borrowed(
                                            "https://example.org/images/ad_icon_img.png"
                                        ),
                                    }],
                                    icon_clicks: Some(IconClicks {
                                        icon_click_fallback_images: Some(IconClickFallbackImages {
                                            icon_click_fallback_images: vec![
                                                IconClickFallbackImage {
                                                    alt_text: Some(Cow::Borrowed(
                                                        "The live click interaction"
                                                    )),
                                                    static_resource: Some(Cow::Borrowed(
                                                        "https://example.org/images/ad_icon_clicked.png"
                                                    )),
                                                    ..Default::default()
                                                }
                                            ],
