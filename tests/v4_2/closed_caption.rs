    ...
    Vast {
        ...
        ads: vec![Ad {
            ...
            in_line: Some(InLine {
                ...
                ad_serving_id: Cow::Borrowed("a532d16d-4d7f-4440-bd29-2ec0e693fc83"),
                    ...
                    creatives: vec![Creative {
                        ...
                        linear: Some(Linear {
                            ...
                            media_files: Some(MediaFiles {
                                ...
                                closed_caption_files: Some(ClosedCaptionFiles {
                                    closed_caption_files: vec![
                                        ClosedCaptionFile {
                                            mime_type: Some(Cow::Borrowed("text/srt")),
                                        ...
                                        ClosedCaptionFile {
                                            mime_type: Some(Cow::Borrowed("text/srt")),
                                            language: Some(Cow::Borrowed("fr")),
                                            uri: Cow::Borrowed(
                                                "https://mycdn.example.com/creatives/creative001-1.srt"
                                            ),
                                        },
                                        ClosedCaptionFile {
                                            mime_type: Some(Cow::Borrowed("text/vtt")),
                                            language: Some(Cow::Borrowed("zh-TW")),
                                            uri: Cow::Borrowed(
                                                "https://mycdn.example.com/creatives/creative001.vtt"
                                            ),
                                        },
                                        ClosedCaptionFile {
                                            mime_type: Some(Cow::Borrowed("application/ttml+xml")),
                                            language: Some(Cow::Borrowed("zh-CH")),
                                            uri: Cow::Borrowed(
                            ...
                            tracking_events: Some(TrackingEvents {
                                trackings: vec![
                                    ...
                                    Tracking {
                                        ...
                                        offset: Some(Offset::Duration(Duration::new(00, 00, 10, 0))),
                                        uri: Cow::Borrowed(
